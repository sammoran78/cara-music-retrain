# Adapted from Hugging Face Diffusers `scripts/convert_ace_step_to_diffusers.py`.
# Kept local so Azure benchmark jobs can build a Diffusers-format ACE-Step
# pipeline from the mounted ACE-Step bundle without a runtime GitHub fetch.
#
